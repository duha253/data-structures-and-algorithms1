...
const getNames = (arr) => {
  // Solution code here...
  let array=arr.map(element=> element.name.split('').reverse().join(''));// i tried to use reduce but it didnt woked.
  //
  return array;
};
/* ------------------------------------------------------------------------------------------------
...
const count = (target, input) => {
  // Solution code here...
  return input.reduce((acc,value,indx)=>{
...
const divisibleByFiveTwoToThePower = (input) => {
  // Solution code here...                                                             //to filter        to make the 2 powerd by the number.
...
let findMaleAndFemale = (data) => {
  // Solution code here...
  let mfArray = data.filter(value =>{
    if (value.gender ==='female'|| value.gender ==='male'){
      return value.name;
    }
  }).map(element =>element.name).join(' and ');//  we have to add the spaces to make the test works
  return mfArray;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
//return sorted[0].name; };// to access the name .
